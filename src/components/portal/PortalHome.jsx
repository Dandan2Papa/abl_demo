  ...
  return (
    ...
    >
      ...
      <div
        style={{
          height: "4px",
          background: `linear-gradient(90deg, ${C.navy} 0%, ${C.dongyangBlue} 100%)`,
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            cursor: "pointer",
            border: `3px solid ${C.dongyangBlue}`,
        ...
        >
          ...
          <button
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.background = C.dongyangBlue;
            }}
          >
            시작하기 →
          </button>
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = "#A90019";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = C.ablRed;
            }}
          >
            시작하기 →
          </button>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            {[
              {
                title: "멀티 LLM 지원",
                desc: "GPT-4o, Claude, HyperCLOVA X 등 최신 언어모델 통합 지원",
              },
              {
                title: "통합 RAG 엔진",
                desc: "42Maru 자체 RAG, 문서 구조화, 정확한 답변 하이라이트",
              },
              {
                title: "AI 가드레일",
                desc: "보험업 특화 필터링, 개인정보 자동 마스킹, 할루시네이션 방지",
              },
            ].map((feature, idx) => (
              <div
                key={idx}
